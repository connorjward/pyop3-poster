...
\begin{itemize}
	\item
		Mesh data has a complicated structure (\cref{fig:sv_element}, \cref{fig:dof_layout}) that maps poorly to existing ways of describing data layouts, like N-dimensional arrays.
	\item
...
\begin{figure}[H]
	...
	\parbox{0.49\textwidth}{
		\caption{
			Different views of a possible data layout for a one-cell mesh of the finite element pair in \cref{fig:sv_element}.
		}
